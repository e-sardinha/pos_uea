# Trabalho de Machine Learning Aplicado II
...
**Código:** `Trabalho_ML2.ipynb`

**Dados:** `Life Expectancy Data.csv`

## Execução

Fazer download do notebook e executá-lo em um IDE como **VSCode**, **JupyterLab** ou no **Google Colab**.

Não é necessário baixar o arquivo *.csv, o notebook faz o download dele automaticamente.